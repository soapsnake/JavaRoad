...
import com.soapsnake.lite.core.CoroutineState.Incomplete
...
import com.soapsnake.lite.suspendCancellableCoroutine
...
abstract class AbstractCoroutine<T> (context: CoroutineContext) : Job, Continuation<T>, CoroutineScope1 {
    ...
    override val context: CoroutineContext = TODO()
