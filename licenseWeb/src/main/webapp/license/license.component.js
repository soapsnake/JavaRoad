...
module('license', ['service', 'service.user', 'datatables', 'datatables.bootstrap', 'datatables.buttons', 'ui.bootstrap', 'ui.bootstrap.tpls'])
    .component('license', {
        ...
        //数组前几个元素为provider
        controller: ['DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder', '$q', '$scope', '$compile', '$modal', '$http', '$sce',
            function licenseController(DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $q, $scope, $compile, $modal, $http, $sce, FileSaver) {
                //定义变量
                var self = this;
                var dtInstance = {};
                var message = '';
                ...
                self.dtColumns = [
                    ...
                    DTColumnBuilder.newColumn('licenseState').withTitle('licenseState'),
